...
public class ParallelFractalGenerator {
    ...
    public ParallelFractalGenerator(int n, int eqCount, int it, int xRes, int yRes, int symmetries, double gamma) {
        this.n = n;
    ...
    private static Transformation createSymmetricTransformation(double[] coeff, double angle) {
        return point -> {
            ...
            double resultY = coeff[NUM_3] * point.x() + coeff[NUM_3] * point.y() + coeff[NUM_5];
